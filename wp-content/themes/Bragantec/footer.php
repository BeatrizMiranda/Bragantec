      ...
      <div class="row">
        ...
        <div class="row col-md-12 apoios">
          <div class="col-md-6 row text-sm-center">
            <img class="col-md-3 col-xs-1 imgIfMeninas " src="<?php echo get_stylesheet_directory_uri()?>/img/ifMeninas.png" alt="Logo if Meninas" width="20" height="120">
            <div class="col-md-9 col-xs-9">
              <p>Esse site foi desenvolvido em parceria com o IFMeninas, grupo que apoia meninas na computação. </p><br>
